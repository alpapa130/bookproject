...
SECRET_KEY = 'django-insecure-$z=s+yj117l773p#_(oij7(-n(s^yt)8&f!_gdqi@u7t&1s+we'
...
if not DEBUG:
    DATABASES = {
        'dafault' : dj_database_url.config(
            ...
            dafult ='postgresql://postgres:postgres@localhost:5432/bookproject', conn_max_age=600
        )
    }
